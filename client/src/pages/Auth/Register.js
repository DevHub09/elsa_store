...
// toast.success("Registere succesfully")
  ...
  <div className="mb-3">
    ...
    type="text" className="form-control" id="exampleInputName" required placeholder='enter your name' />
  </div>
  ...
  <div className="mb-3">
    ...
    type="text" className="form-control" id="exampleInputName" required placeholder='enter your phone' />
  </div>
  <div className="mb-3">
    <input value={address} onChange={(e) => setAddress(e.target.value)}
     type="text" className="form-control"  required id="exampleInputName" placeholder='enter your address' />
  </div>
